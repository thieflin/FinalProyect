...
Shader "Custom/WallCutout"
{
	Properties
	{
		...
		_PlayerPosition1("PlayerPosition", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		uniform float3 _PlayerPosition1;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float smoothstepResult384 = smoothstep( 0.0 , _SmoothBorder , saturate( ( 1.0 - length( ( ((( float4( float3(0.02,-0.07,0) , 0.0 ) + ScreenPosition429 )*1.0 + ( float4( _PlayerPosition1 , 0.0 ) + ScreenPosition429 )).xy*2.0 + -1.0) / appendResult4_g2 ) ) ) ));
...
/*ASEBEGIN
Version=18900
0;73;1007;682;3880.781;1256.808;3.004697;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;231;-2844.44,104.1283;Float;False;Property;_CutoutSizee;Cutout Sizee;3;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;421;-2874.49,-718.2174;Inherit;False;Constant;_CenterCutout;CenterCutout;6;0;Create;True;0;0;0;False;0;False;0.02,-0.07,0;0.02,-0.07,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;452;-2880.618,-491.7236;Inherit;False;Property;_PlayerPosition1;PlayerPosition;5;0;Create;True;0;0;0;False;0;False;0,0,0;-0.485082,-0.581287,-13.973;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;441;-813.7906,-421.1313;Inherit;False;Property;_Metallic;Metallic;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=A0310532B039A5892BBF233D4D30440C180D9163